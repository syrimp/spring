			...
			<form action="/board/modify" method="post">
				<table class="get_table">
						<tr>
							...
							<th>회원 아이디</th><td><input type="text" name="id" value="${board.id }"></td>
						</tr><tr>
							<th>작성일</th><td><input type="text" name="regdate" value="${board.regdate }"></td>
						</tr><tr>
							<th>수정일</th><td><input type="text" name="updatedate" value="${board.updatedate }"></td>
						</tr><tr>
